...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'label' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-06-01 18:12:08',
                'modifield' => '2019-06-01 18:12:08'
            ],
        ];
        parent::init();
    }
