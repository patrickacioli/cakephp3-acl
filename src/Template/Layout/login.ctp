...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Secretaria de Saúde de Pio IX | Login</title>
		...
		<link href="<?php echo $this->request->webroot; ?>assets/app/custom/login/login-v3.default.css" rel="stylesheet" type="text/css" />
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v3 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(<?php echo $this->request->webroot; ?>assets/media//bg/bg-3.jpg);">
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Entrar no painel</h3>
								</div>
                  <?php echo $this->Form->create(null, ['class' => 'kt-form']) ?>
									<div class="input-group">
                    <input class="form-control" type="text" placeholder="Senha" name="username" id="username">
									</div>
									<div class="input-group">
										<input class="form-control" type="password" placeholder="Senha" name="password" id="username">
									</div>
									<div class="row kt-login__extra">
										<div class="col">
											<label class="kt-checkbox">
												<input type="checkbox" name="remember"> Lembrar meus dados
												<span></span>
											</label>
										</div>
										<div class="col kt-align-right">
											<a href="javascript:;" id="kt_login_forgot" class="kt-login__link">Tenho um problema para entrar.</a>
										</div>
									</div>
									<div class="kt-login__actions">
										<button type="submit" id="" class="btn btn-brand btn-elevate kt-login__btn-primary">Entrar</button>
									</div>
		...
		<script src="<?php echo $this->request->webroot; ?>assets/app/custom/login/login-general.js" type="text/javascript"></script>
